...
3.  **Precise Bounding Boxes:** For every element, provide an exact bounding box that tightly encloses the entire logical block. The coordinates (x, y, width, height) must be normalized from 0 to 1 relative to the page size.
